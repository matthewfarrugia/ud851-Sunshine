...
public class MainActivity extends AppCompatActivity {
    ...
    protected void loadWeatherData(){
        ...
        new FeatchWeather().execute(location);
    }
    ...
    class FeatchWeather extends AsyncTask<String,Void,String[]> {
        ...
        public String[] doInBackground(String... params) {
            ...
            URL networkRequestUrl = NetworkUtils.buildUrl(location);

            try {
                String jsonWeatherResponse = NetworkUtils.getResponseFromHttpUrl(networkRequestUrl);

                String[] simpleWeatherResponse = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this,jsonWeatherResponse);
