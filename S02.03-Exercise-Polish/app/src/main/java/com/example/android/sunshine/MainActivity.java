...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mWeatherNetworkErrorTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWeatherNetworkErrorTextView = (TextView) findViewById(R.id.network_error);
        mWeatherProgressBar = (ProgressBar) findViewById(R.id.progress_bar);
    ...
    private void showWeatherDataView() {
        mWeatherNetworkErrorTextView.setVisibility(View.INVISIBLE);
        mWeatherTextView.setVisibility(View.VISIBLE);
    }

    private void showErrorMessage() {
        mWeatherTextView.setVisibility(View.INVISIBLE);
        mWeatherNetworkErrorTextView.setVisibility(View.VISIBLE);
    }
